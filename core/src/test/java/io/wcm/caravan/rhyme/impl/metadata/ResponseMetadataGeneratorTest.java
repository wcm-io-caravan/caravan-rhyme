...
public class ResponseMetadataGeneratorTest {
  ...
  @Test
  void default_output_max_age_should_be_null() throws Exception {

    assertThat(metrics.getResponseMaxAge()).isNull();
  }

  @Test
  void output_max_age_should_be_null_if_no_max_age_present_in_upstream_response() throws Exception {
  ...
  @Test
  void max_age_limit_should_handle_durations_longer_than_max_int() throws Exception {
  ...
  @Test
  void max_age_limit_should_be_used_if_no_resources_are_requested() throws Exception {
  ...
  @Test
  void max_age_limit_should_use_lowest_value_of_multiple_calls() throws Exception {
  ...
  @Test
  void max_age_limit_should_use_lowest_value_of_multiple_calls_2() throws Exception {
  ...
  @Test
  void max_age_limit_should_be_used_if_if_no_max_age_present_in_upstream_response() throws Exception {
  ...
  @Test
  void max_age_limit_should_be_used_if_its_smaller_than_max_age_from_upstream_response() throws Exception {
  ...
  @Test
  void max_age_from_upstream_resource_should_be_used_if_no_limit_is_set() throws Exception {
  ...
  @Test
  void max_age_from_upstream_resource_should_be_used_if_its_smaller_than_limit() throws Exception {
  ...
  @Test
  void smallest_max_age_from_upstream_resources_should_be_used_if_no_limit_is_set() throws Exception {
  ...
  @Test
  void metadata_resource_can_be_created_without_interactions() throws Exception {
  ...
  @Test
  void metadata_resource_can_be_created_with_null_resource_instance() throws Exception {
  ...
  @Test
  void metadata_resource_contains_source_links() throws Exception {
  ...
  @Test
  void metadata_resource_contains_embedded_details_metrics_if_timings_were_collected() throws Exception {
  ...
  @Test
  void metadata_resource_contains_no_embedded_details_metrics_if_no_timings_were_collected() throws Exception {
  ...
  @Test
  void metadata_resource_contains_sum_of_invocation_and_response_times() throws Exception {
  ...
  @Test
  void responses_that_were_retrieved_after_metadata_generation_should_be_ignored() throws Exception {
