...
/**
 * Loads the HTML documentation for a {@link HalApiInterface} from the classpath resource that was
 * generated by the rhyme-docs-maven-plugin
 */
public class RhymeDocsProvider {
  ...
  /**
   * @param support implements the logic for opening the resource stream for a given file name
   */
  ...
  /**
   * @param fileName of the HTML resource, usually the fully qualified class name of the interface followed by ".html"
   * @return the content of the HTML documentation file
   * @throws HalApiDeveloperException if no {@link RhymeDocsSupport} was configured
   * @throws HalApiServerException if the HTML could not be loaded
   */
