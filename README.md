...
In both cases, you should extend the [AbstractHalResourceLoaderTest](src/test/java/io/wcm/caravan/rhyme/testing/client/AbstractHalResourceLoaderTest.java) 
