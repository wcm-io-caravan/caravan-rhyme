...
public class JaxRsAsyncHalResponseHandlerImplTest {
  ...
  @Test
  void respondWith_should_handle_successfull_rendering() throws Exception {
  ...
  @Test
  void respondWith_should_sets_cache_control_header() throws Exception {
  ...
  @Test
  void respondWith_should_render_runtime_exceptions_with_vnderror_resource() throws Exception {
  ...
  @Test
  void respondWith_should_extract_status_code_from_jaxrs_exceptions() throws Exception {
  ...
  @Test
  void respondWith_should_resume_with_fatal_error_thrown_in_resource() throws Exception {
  ...
  @Test
  void respondWith_should_resume_with_fatal_error_thrown_in_handler() throws Exception {
  ...
  @Test
  void respondWithError_should_extract_status_code_from_jaxrs_exceptions() throws Exception {
  ...
  @Test
  void respondWithError_should_resume_with_fatal_error_thrown_in_handler() throws Exception {
  ...
  @Test
  void respondWithError_should_handle_null_uris() throws Exception {
